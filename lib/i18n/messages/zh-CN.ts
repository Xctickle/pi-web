...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "asyncTasks.title": "异步任务",
    "asyncTasks.loadError": "加载异步任务状态失败",
    "asyncTasks.empty": "未在 {dir} 发现任务书",
    "asyncTasks.taskCount": "{count} 个任务",
    "asyncTasks.statusDone": "已完成",
    "asyncTasks.statusPending": "未完成",
    "asyncTasks.briefMissing": "任务书缺失",
    "asyncTasks.cronSchedule": "调度",
    "asyncTasks.cronDaily": "每日 {times}",
    "asyncTasks.cronWeekly": "每{weekdays} {times}",
    "asyncTasks.noCron": "无 crontab 调度（async-task.sh）",
    "asyncTasks.crontabUnavailable": "无法读取 crontab：{error}",
    "asyncTasks.lastRun": "最近运行",
    "asyncTasks.lastRunNone": "从未运行",
    "asyncTasks.exitCode": "exit {code}",
    "asyncTasks.doneAt": "完成标记",
    "asyncTasks.failedLogs": "失败日志",
    "asyncTasks.showRunLog": "查看运行日志",
    "asyncTasks.hideRunLog": "收起运行日志",
    "asyncTasks.showBrief": "任务书",
    "asyncTasks.hideBrief": "收起任务书",
    "asyncTasks.nightGuard": "夜间守卫",
    "asyncTasks.keepAwakeOff": "保夜关闭",
    "asyncTasks.keepAwakeAlways": "保夜开启（长期）",
    "asyncTasks.keepAwakeUntil": "保夜至 {date}",
    "asyncTasks.nightLogTitle": "night-shutdown.log（尾部）",
    "asyncTasks.nightLogMissing": "暂无夜间守卫日志",
    "asyncTasks.readOnlyNote": "看板可编辑：改动直接写入任务目录与 crontab",
    "asyncTasks.col.draft": "草稿",
    "asyncTasks.col.scheduled": "待执行",
    "asyncTasks.col.done": "已完成",
    "asyncTasks.col.failed": "异常",
    "asyncTasks.newTask": "新建任务",
    "asyncTasks.runNow": "立即运行",
    "asyncTasks.runDoneConfirm": "任务已标记完成，重新运行前需清除完成标记。要清除并运行吗？",
    "asyncTasks.markDone": "标记完成",
    "asyncTasks.resetPending": "重置为待执行",
    "asyncTasks.markedDoneAt": "完成于",
    "asyncTasks.taskName": "任务名",
    "asyncTasks.taskNamePlaceholder": "kebab-case，如 my-task",
    "asyncTasks.briefSection": "任务书",
    "asyncTasks.briefPlaceholder": "Markdown 任务书，由无头 agent 执行…",
    "asyncTasks.save": "保存",
    "asyncTasks.saveBrief": "保存任务书",
    "asyncTasks.scheduleSection": "调度",
    "asyncTasks.scheduleNone": "无调度",
    "asyncTasks.scheduleDaily": "每日",
    "asyncTasks.scheduleWeekly": "每周",
    "asyncTasks.scheduleMonthly": "每月",
    "asyncTasks.dayOfMonth": "每月几号",
    "asyncTasks.timePlaceholder": "HH:MM",
    "asyncTasks.addTime": "添加",
    "asyncTasks.autoClear": "运行前自动清除完成标记（滚动任务）",
    "asyncTasks.autoClearShort": "滚动",
    "asyncTasks.rollingLastDone": "上轮完成 {time}",
    "asyncTasks.rollingRetireConfirm": "滚动任务移入「已完成」＝移除其调度并停用（不再自动重跑），保留完成标记。确定停用吗？",
    "asyncTasks.rollingToDraftConfirm": "滚动任务移入「草稿」＝移除其调度并清除完成标记。确定停用并移回草稿吗？",
    "asyncTasks.rollingStayScheduled": "滚动任务常驻待执行列，完成标记仅表示当前轮次",
    "asyncTasks.rollingNote": "滚动任务：完成标记仅表示当前轮次，下轮触发前会被自动清除",
    "asyncTasks.cronPreview": "将写入 crontab：",
    "asyncTasks.saveSchedule": "保存调度",
    "asyncTasks.removeSchedule": "移除调度",
    "asyncTasks.scheduleRaw": "当前调度为高级表达式，保存后将替换为结构化调度：",
    "asyncTasks.modelSection": "模型覆盖",
    "asyncTasks.modelPlaceholder": "留空使用默认 {model}",
    "asyncTasks.runSection": "最近运行",
    "asyncTasks.clearFailed": "清除失败日志",
    "asyncTasks.deleteTask": "删除任务",
    "asyncTasks.deleteConfirm": "将删除任务书、完成标记、运行/失败日志与 crontab 调度，不可恢复。确定？",
    "asyncTasks.dragHint": "拖动卡片改状态：已完成 = 打标记 · 待执行 = 清标记 · 草稿 = 移除调度",
    "asyncTasks.actionDone": "已更新",
    "asyncTasks.actionFailed": "操作失败",
    "asyncTasks.runStarted": "已触发运行，稍后刷新查看结果",
    "asyncTasks.invalidName": "任务名仅限小写字母、数字与连字符",
    "asyncTasks.createTask": "创建任务",
    "asyncTasks.lastExitFail": "运行失败",
    "asyncTasks.histFailed": "历史失败 {count}",
    "asyncTasks.nightGuardShort": "夜间守卫",
    "asyncTasks.nightLogShow": "守卫日志",
    "asyncTasks.nightLogHide": "收起日志",
    "asyncTasks.weekday.0": "周日",
    "asyncTasks.weekday.1": "周一",
    "asyncTasks.weekday.2": "周二",
    "asyncTasks.weekday.3": "周三",
    "asyncTasks.weekday.4": "周四",
    "asyncTasks.weekday.5": "周五",
    "asyncTasks.weekday.6": "周六",
    "backups.title": "备份",
    "backups.loadError": "加载备份状态失败",
    "backups.dirMissing": "备份目录不存在：{dir}",
    "backups.latestBackup": "最新备份",
    "backups.rpoOk": "在 RPO 目标内 — {age}前",
    "backups.rpoOverdue": "已超期：上次备份 {age}前（目标 {target} 小时）",
    "backups.rpoNone": "尚无备份",
    "backups.agoMinutes": "{minutes} 分钟前",
    "backups.agoHours": "{hours} 小时前",
    "backups.agoDays": "{days} 天前",
    "backups.archivesCount": "全史 {total} 条 · 现存 {present} · 已清理 {rotated} · 现存共 {size}",
    "backups.latestChip": "最新",
    "backups.sha256": "SHA-256 校验文件",
    "backups.sha256Ok": "sha256 在",
    "backups.sha256Missing": "sha256 缺失",
    "backups.sidecarNote": "列表默认只检查 .sha256 旁文件是否存在；“校验最新”才会真正执行 sha256sum -c。",
    "backups.rotatedChip": "已清理",
    "backups.download": "下载",
    "backups.scriptTitle": "备份脚本",
    "backups.scriptMissing": "未找到备份脚本：{path}",
    "backups.scriptShow": "展开",
    "backups.scriptHide": "收起",
    "backups.healthTitle": "健康总览",
    "backups.continuityTitle": "近 14 天连续性",
    "backups.heatDay": "{date} · {count} 份 · 最新 {time}",
    "backups.heatDayEmpty": "{date} · 无备份",
    "backups.trendTitle": "备份大小趋势（最近 {count} 份）",
    "backups.trendOversizeNote": "单份 >50MB 标红（异常信号）",
    "backups.trendBar": "{file} · {size} · {time}",
    "backups.remoteTitle": "远端副本（syncthing · kb）",
    "backups.remoteUnreachable": "syncthing 不可达（不算错误，可稍后刷新）",
    "backups.remoteUnknown": "未知",
    "backups.remoteNote": "各远端设备对 kb 文件夹的同步完成度",
    "backups.runNow": "立即备份",
    "backups.runRunning": "备份运行中…",
    "backups.runStarted": "已触发备份，后台运行中",
    "backups.runDone": "备份完成：{file}",
    "backups.runEndedNoArchive": "备份进程已结束，但未见新归档（详见 ~/.pi/backup.log）",
    "backups.runAlready": "已有备份在运行，等待其完成",
    "backups.verify": "校验最新",
    "backups.verifyBusy": "校验中…",
    "backups.verifyOk": "校验通过",
    "backups.verifyFailed": "校验失败",
    "backups.verifyAtOk": "上次校验 {at} · 通过",
    "backups.verifyAtFail": "上次校验 {at} · 失败：{error}",
    "backups.actionFailed": "操作失败",
    "backups.footerNote": "立即备份 / 校验 / 下载直接作用于生产目录；列表已合并 index.log 全史",
  },
};
