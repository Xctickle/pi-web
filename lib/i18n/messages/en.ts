...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "backups.archivesCount": "{count} archives · {size}",
    ...
    "backups.sidecarNote": "Integrity check verifies the .sha256 sidecar exists; the checksum itself is not recomputed here.",
    "backups.scriptTitle": "Backup script",
    "backups.scriptMissing": "Backup script not found: {path}",
    "backups.remoteV2": "Remote replicas (NAS / offsite / cloud) will be integrated in V2.",
    "backups.readOnlyNote": "Read-only view",
  },
};
