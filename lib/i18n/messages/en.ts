...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "asyncTasks.title": "Async Tasks",
    "asyncTasks.loadError": "Failed to load async task status",
    "asyncTasks.empty": "No task briefs found in {dir}",
    "asyncTasks.taskCount": "{count} tasks",
    "asyncTasks.statusDone": "Done",
    "asyncTasks.statusPending": "Not done",
    "asyncTasks.briefMissing": "Task brief missing",
    "asyncTasks.cronSchedule": "Schedule",
    "asyncTasks.cronDaily": "Daily at {times}",
    "asyncTasks.cronWeekly": "Weekly {weekdays} at {times}",
    "asyncTasks.noCron": "No crontab entry (async-task.sh)",
    "asyncTasks.crontabUnavailable": "crontab unavailable: {error}",
    "asyncTasks.lastRun": "Last run",
    "asyncTasks.lastRunNone": "Never run",
    "asyncTasks.exitCode": "exit {code}",
    "asyncTasks.doneAt": "Marked done",
    "asyncTasks.failedLogs": "Failure logs",
    "asyncTasks.showRunLog": "Show run log",
    "asyncTasks.hideRunLog": "Hide run log",
    "asyncTasks.showBrief": "Task brief",
    "asyncTasks.hideBrief": "Hide brief",
    "asyncTasks.nightGuard": "Night guard",
    "asyncTasks.keepAwakeOff": "Keep-awake off",
    "asyncTasks.keepAwakeAlways": "Keep-awake on (indefinite)",
    "asyncTasks.keepAwakeUntil": "Keep-awake until {date}",
    "asyncTasks.nightLogTitle": "night-shutdown.log (tail)",
    "asyncTasks.nightLogMissing": "No night guard log yet",
    "asyncTasks.readOnlyNote": "Editable board: changes write to the tasks dir and crontab",
    "asyncTasks.col.draft": "Draft",
    "asyncTasks.col.scheduled": "Scheduled",
    "asyncTasks.col.done": "Done",
    "asyncTasks.col.failed": "Failed",
    "asyncTasks.newTask": "New task",
    "asyncTasks.runNow": "Run now",
    "asyncTasks.runDoneConfirm": "Task is marked done. Re-running needs the done marker cleared first. Clear and run?",
    "asyncTasks.markDone": "Mark done",
    "asyncTasks.resetPending": "Reset to pending",
    "asyncTasks.markedDoneAt": "Done at",
    "asyncTasks.taskName": "Task name",
    "asyncTasks.taskNamePlaceholder": "kebab-case, e.g. my-task",
    "asyncTasks.briefSection": "Task brief",
    "asyncTasks.briefPlaceholder": "Markdown brief executed by the headless agent…",
    "asyncTasks.save": "Save",
    "asyncTasks.saveBrief": "Save brief",
    "asyncTasks.scheduleSection": "Schedule",
    "asyncTasks.scheduleNone": "None",
    "asyncTasks.scheduleDaily": "Daily",
    "asyncTasks.scheduleWeekly": "Weekly",
    "asyncTasks.scheduleMonthly": "Monthly",
    "asyncTasks.dayOfMonth": "Day of month",
    "asyncTasks.timePlaceholder": "HH:MM",
    "asyncTasks.addTime": "Add",
    "asyncTasks.autoClear": "Clear done marker before run (rolling task)",
    "asyncTasks.autoClearShort": "rolling",
    "asyncTasks.rollingLastDone": "Last round done {time}",
    "asyncTasks.rollingRetireConfirm": "Moving a rolling task to Done removes its schedule and retires it (no more automatic runs); the done marker is kept. Retire it?",
    "asyncTasks.rollingToDraftConfirm": "Moving a rolling task to Draft removes its schedule and clears the done marker. Retire it and move it to Draft?",
    "asyncTasks.rollingStayScheduled": "Rolling tasks stay in Scheduled; the done marker only reflects the current round",
    "asyncTasks.rollingNote": "Rolling task: the done marker only marks the current round; it is cleared automatically before the next run",
    "asyncTasks.cronPreview": "Crontab lines to write:",
    "asyncTasks.saveSchedule": "Save schedule",
    "asyncTasks.removeSchedule": "Remove schedule",
    "asyncTasks.scheduleRaw": "Current schedule uses advanced syntax; saving replaces it with the structured schedule:",
    "asyncTasks.modelSection": "Model override",
    "asyncTasks.modelPlaceholder": "Empty = default {model}",
    "asyncTasks.runSection": "Last run",
    "asyncTasks.clearFailed": "Clear failure logs",
    "asyncTasks.deleteTask": "Delete task",
    "asyncTasks.deleteConfirm": "Deletes the brief, done marker, run/failure logs, and crontab schedule. Irreversible. Continue?",
    "asyncTasks.dragHint": "Drag cards to change state: Done = set marker · Scheduled = clear marker · Draft = remove schedule",
    "asyncTasks.actionDone": "Updated",
    "asyncTasks.actionFailed": "Action failed",
    "asyncTasks.runStarted": "Run triggered — refresh later for results",
    "asyncTasks.invalidName": "Task name allows lowercase letters, digits, and hyphens only",
    "asyncTasks.createTask": "Create task",
    "asyncTasks.lastExitFail": "Failed",
    "asyncTasks.histFailed": "{count} failure log(s)",
    "asyncTasks.nightGuardShort": "Night guard",
    "asyncTasks.nightLogShow": "Guard log",
    "asyncTasks.nightLogHide": "Hide log",
    "asyncTasks.weekday.0": "Sun",
    "asyncTasks.weekday.1": "Mon",
    "asyncTasks.weekday.2": "Tue",
    "asyncTasks.weekday.3": "Wed",
    "asyncTasks.weekday.4": "Thu",
    "asyncTasks.weekday.5": "Fri",
    "asyncTasks.weekday.6": "Sat",
    "backups.title": "Backups",
    "backups.loadError": "Failed to load backup status",
    "backups.dirMissing": "Backup directory not found: {dir}",
    "backups.latestBackup": "Latest backup",
    "backups.rpoOk": "Within RPO target — {age} old",
    "backups.rpoOverdue": "Overdue: last backup {age} old (target {target} h)",
    "backups.rpoNone": "No backups yet",
    "backups.agoMinutes": "{minutes} min ago",
    "backups.agoHours": "{hours} h ago",
    "backups.agoDays": "{days} d ago",
    "backups.archivesCount": "{total} total records · {present} on disk · {rotated} cleaned · {size} on disk",
    "backups.latestChip": "latest",
    "backups.sha256": "SHA-256 checksum sidecar",
    "backups.sha256Ok": "sha256 ok",
    "backups.sha256Missing": "sha256 missing",
    "backups.sidecarNote": "The list only checks that a .sha256 sidecar exists; “Verify latest” actually runs sha256sum -c.",
    "backups.rotatedChip": "cleaned",
    "backups.download": "Download",
    "backups.scriptTitle": "Backup script",
    "backups.scriptMissing": "Backup script not found: {path}",
    "backups.scriptShow": "Expand",
    "backups.scriptHide": "Collapse",
    "backups.healthTitle": "Health overview",
    "backups.continuityTitle": "Last 14 days continuity",
    "backups.heatDay": "{date} · {count} backup(s) · latest {time}",
    "backups.heatDayEmpty": "{date} · no backup",
    "backups.trendTitle": "Backup size trend (last {count})",
    "backups.trendOversizeNote": "Archives >50MB marked red (anomaly signal)",
    "backups.trendBar": "{file} · {size} · {time}",
    "backups.remoteTitle": "Remote replicas (syncthing · kb)",
    "backups.remoteUnreachable": "syncthing unreachable (not an error — refresh later)",
    "backups.remoteUnknown": "unknown",
    "backups.remoteNote": "Per-device sync completion of the kb folder",
    "backups.runNow": "Back up now",
    "backups.runRunning": "Backup running…",
    "backups.runStarted": "Backup triggered, running in background",
    "backups.runDone": "Backup complete: {file}",
    "backups.runEndedNoArchive": "Backup process ended without a new archive (see ~/.pi/backup.log)",
    "backups.runAlready": "A backup is already running — waiting for it",
    "backups.verify": "Verify latest",
    "backups.verifyBusy": "Verifying…",
    "backups.verifyOk": "Checksum OK",
    "backups.verifyFailed": "Checksum failed",
    "backups.verifyAtOk": "Last verified {at} · OK",
    "backups.verifyAtFail": "Last verified {at} · failed: {error}",
    "backups.actionFailed": "Action failed",
    "backups.footerNote": "Back up / verify / download act on the production directory; the list merges full index.log history",
  },
};
