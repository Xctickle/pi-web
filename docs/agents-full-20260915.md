> AGENTS.md full archive (pre-slimming, 2026-09-15). Slimmed per context-budget spec (mind self/spec/context-budget-spec.md, ≤8KB per AGENTS.md): details moved here from AGENTS.md — content preserved, not deleted. New knowledge goes to AGENTS.md, not this file.
